...
import com.coderealm.spectraz.activitesfragments.livestreaming.adapter.MultiCastStatAdapter;
...
public class MultiViewLiveA extends RtcBaseMultiviewA implements View.OnClickListener {
    ...
    private void renderRemoteUser(int uid) {
        Functions.printLog(com.coderealm.spectraz.Constants.tag, "renderRemoteUser "+uid);
