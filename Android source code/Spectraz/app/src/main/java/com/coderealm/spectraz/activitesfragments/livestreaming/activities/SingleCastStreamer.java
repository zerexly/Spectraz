package com.coderealm.spectraz.activitesfragments.livestreaming.activities;
...
import com.coderealm.spectraz.activitesfragments.EditTextSheetF;
import com.coderealm.spectraz.activitesfragments.livestreaming.adapter.LiveCommentsAdapter;
import com.coderealm.spectraz.activitesfragments.livestreaming.adapter.LiveUserViewAdapter;
import com.coderealm.spectraz.activitesfragments.livestreaming.fragments.InviteContactsToStreamF;
import com.coderealm.spectraz.activitesfragments.livestreaming.model.CameraRequestModel;
import com.coderealm.spectraz.activitesfragments.livestreaming.model.LiveCoinsModel;
import com.coderealm.spectraz.activitesfragments.livestreaming.model.LiveCommentModel;
import com.coderealm.spectraz.activitesfragments.livestreaming.model.LiveUserModel;
import com.coderealm.spectraz.activitesfragments.livestreaming.stats.LocalStatsData;
import com.coderealm.spectraz.activitesfragments.livestreaming.stats.RemoteStatsData;
import com.coderealm.spectraz.activitesfragments.livestreaming.stats.StatsData;
import com.coderealm.spectraz.activitesfragments.livestreaming.ui.VideoGridContainer;
import com.coderealm.spectraz.activitesfragments.sendgift.StickerModel;
...
import com.coderealm.spectraz.models.StreamShowHeartModel;
import com.coderealm.spectraz.R;
import com.coderealm.spectraz.models.UsersModel;
import com.coderealm.spectraz.simpleclasses.Functions;
import com.coderealm.spectraz.simpleclasses.OnSwipeTouchListener;
import com.coderealm.spectraz.simpleclasses.Variables;
import com.coderealm.spectraz.simpleclasses.streaminglikes.HeartView;
...
public class SingleCastStreamer extends RtcBaseActivity implements View.OnClickListener {
    ...
    private void ActionControl() {
        ...
        tabMainView.setOnTouchListener(new OnSwipeTouchListener(context) {
            ...
            public void onSwipeRight() {
                ...
                Log.d(com.coderealm.spectraz.Constants.tag,"start");
            ...
            public void onSwipeLeft() {
                ...
                Log.d(com.coderealm.spectraz.Constants.tag,"end");
                if (viewTwo==viewflliper.getCurrentView())
                {
            ...
            joinValueEventListener = new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists())
                    {
                        ...
                        {
                            Log.d(com.coderealm.spectraz.Constants.tag,"Data JSON : "+joinSnapsot.getValue().toString());
        ...
        if (connectCheckListener==null)
        {
            ...
            connectCheckListener=new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (connected) {
                        Log.d(com.coderealm.spectraz.Constants.tag, "connected");
                        timer.cancel();
                    } else {
                        Log.d(com.coderealm.spectraz.Constants.tag, "not connected");
                        timer.cancel();
                        timer = new Timer();
                        timer.schedule(
                                new TimerTask() {
                ...
                @Override
                public void onCancelled(@NonNull DatabaseError error) {
                    Log.w(com.coderealm.spectraz.Constants.tag, "Listener was cancelled");
                }
            };
    ...
    private void initUI() {
        ...
        rtcEngine().setBeautyEffectOptions(isbeautyActivated,
                com.coderealm.spectraz.activitesfragments.livestreaming.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initData() {
        Functions.printLog(com.coderealm.spectraz.Constants.tag, "initData");
        mVideoDimension = com.coderealm.spectraz.activitesfragments.livestreaming.Constants.VIDEO_DIMENSIONS[
    ...
    public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Functions.printLog(com.coderealm.spectraz.Constants.tag, "onFirstRemoteVideoDecoded");
    ...
    private void renderRemoteUser(int uid) {
        Functions.printLog(com.coderealm.spectraz.Constants.tag, "renderRemoteUser");
    ...
    public void onRemoteAudioStats(IRtcEngineEventHandler.RemoteAudioStats stats) {
        Functions.printLog(com.coderealm.spectraz.Constants.tag, "onRemoteAudioStats");
        if (!statsManager().isEnabled()) return;
