...
import com.coderealm.spectraz.activitesfragments.CustomErrorActivity;
import com.coderealm.spectraz.activitesfragments.livestreaming.Constants;
import com.coderealm.spectraz.activitesfragments.livestreaming.rtc.AgoraEventHandler;
import com.coderealm.spectraz.activitesfragments.livestreaming.rtc.EngineConfig;
import com.coderealm.spectraz.activitesfragments.livestreaming.rtc.EventHandler;
import com.coderealm.spectraz.activitesfragments.livestreaming.stats.StatsManager;
import com.coderealm.spectraz.activitesfragments.livestreaming.utils.FileUtil;
import com.coderealm.spectraz.activitesfragments.livestreaming.utils.PrefManager;
import com.coderealm.spectraz.interfaces.InternetCheckCallback;
...
import static com.coderealm.spectraz.simpleclasses.ImagePipelineConfigUtils.getDefaultImagePipelineConfig;
...
public class TicTic extends Application implements Application.ActivityLifecycleCallbacks, BackgroundDetectorHandler.OnVisibilityChangedListener {
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"))
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Log.d(com.coderealm.spectraz.Constants.tag,"removeOnlineStatus: "+Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"));
                };
            });
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            ...
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0")).setValue(onlineModel)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            Log.d(com.coderealm.spectraz.Constants.tag,"addOnlineStatus: "+onlineModel.getUserId());
                        };
                    });
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        Log.d(com.coderealm.spectraz.Constants.tag,"token: "+token);
    ...
    {
        Log.d(com.coderealm.spectraz.Constants.tag,"onAppGoesToBackground");
        removeOnlineListener();
    }
    ...
    {
        Log.d(com.coderealm.spectraz.Constants.tag,"onAppGoesToForeground");
        addOnlineListener();
    }
