...
import com.coderealm.spectraz.activitesfragments.livestreaming.stats.StatsManager;
import com.coderealm.spectraz.activitesfragments.livestreaming.ui.VideoGridContainer;
import com.coderealm.spectraz.activitesfragments.sendgift.StickerGiftF;
...
import com.coderealm.spectraz.models.UserOnlineModel;
        ...
        StickerGiftF giftFragment = new StickerGiftF(item.getUserId(), item.getUserName(), item.getUserPicture(), new FragmentCallBack() {
            ...
            public void onResponce(Bundle bundle) {
                if (bundle.getBoolean("isShow",false))
                {
                    ...
                    Log.d(com.coderealm.spectraz.Constants.tag,"Test : "+streamerLiveModel.getUserCoins());
...
//                            tabJoinVideo.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.ic_non_duet_post_new));
    ...
    {
        return com.coderealm.spectraz.activitesfragments.livestreaming.Constants.VIDEO_DIMENSIONS[
