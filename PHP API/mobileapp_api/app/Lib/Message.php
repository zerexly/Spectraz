...
class Message {
    ...
    public static function EDITRESTRICTED(){

        $msg = array(
            'code'=> 202,
            'msg' => 'You cannot edit this. Please contact the administrator'
        );
        echo json_encode($msg);

    }

    public static function DELETERESTRICTED(){

        $msg = array(
            'code'=> 202,
            'msg' => 'You cannot delete this.Please contact the administrator'
        );
        echo json_encode($msg);
