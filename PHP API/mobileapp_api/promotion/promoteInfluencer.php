        ...
        <div class="tab-content" id="myTabContent">
            <div class="mainHeader">
                <div class="mainHeaderTop">
                    ...
                    <a class="btnNext fright" style="font-size: 17px;color: black;z-index: 9999;position: relative;font-weight: 400;" onclick="select_influencer_move_on_budget()" >
                        Done
                    </a>
                    <h3 class="tabsMainHeading">Promote With Influencer</h3>
                    <div class="clear"></div>
                </div>
            </div>
                            ...
                            <div class="audbarHead az_audbarHead">
                                <div style="margin-bottom: 6px;">
                                    <div style="margin-top: 10px;">
                                        ...
                                        <input class="locationPlace" id="search_location" onkeyup="search_user_keyword('<?php echo $user_id; ?>')" type="text" placeholder="Add Influencer" style="-webkit-appearance: none;background: #FAFAFA;padding: 10px 0 10px 32px;font-size: 14px;font-weight: 400;border: solid 1px #eee;border-radius: 3px;" autocomplete="false" >
                                    </div>
