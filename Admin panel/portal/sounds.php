                                                            ...
                                                            <div class="more">
                                                                ...
                                                                <div class="more-menu">
                                                                    ...
                                                                    <ul class="more-menu-items" tabindex="-1" role="menu" aria-labelledby="more-btn" aria-hidden="true">
                                                                        ...
                                                                        <li class="more-menu-item" role="presentation" onclick="assignSection('<?php echo $singleRow['Sound']['id']; ?>')">
                                                                            <button type="button" class="more-menu-btn" role="menuitem">Assign Section</button>
                                                                        </li>
